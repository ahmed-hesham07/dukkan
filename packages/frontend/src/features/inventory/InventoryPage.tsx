...
export default function InventoryPage() {
  ...
  const [newProduct, setNewProduct] = useState({
    name: '', price: '', stock: '0', lowStockThreshold: '5',
  });
  ...
  return (
    <div className="page-container">
      ...
      <div className="p-4 space-y-4">
        ...
        {showAddForm && (
          <div
            className="rounded-3xl p-5 space-y-4 animate-slide-down"
            style={{
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: isLow ? '1px solid rgba(247,37,133,0.25)' : '1px solid rgba(255,255,255,0.07)',
                    boxShadow: isLow ? '0 4px 20px rgba(247,37,133,0.1)' : '0 4px 20px rgba(0,0,0,0.3)',
                  }}
                >
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        ...
                        >
                          {p.price.toFixed(2)}
                          <span className="text-sm font-semibold ms-1" style={{ WebkitTextFillColor: 'rgba(255,255,255,0.4)' }}>
                            {t('common.egp')}
                          </span>
                        </p>
                      </div>
                      <div className="text-end flex-shrink-0">
                        <span
                          ...
                          style={{ color: isLow ? '#f72585' : '#10b981' }}
                        >
                          {p.stock}
                        </span>
                        {isLow && (
                    ...
                    {isAdjusting ? (
                      <div className="mt-4 space-y-3 animate-slide-down">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            className="font-bold rounded-2xl py-3.5 text-base text-white active:scale-95 transition-all"
                            style={{
                      ...
                      <button
                        className="mt-3 w-full rounded-2xl py-2.5 text-sm font-semibold text-white/60 transition-all active:scale-95"
